  ...
  return (
    <div className="py-20 px-6 bg-gray-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
        ...
        {/* Developer Section - Blue Highlighted Card */}
<div className="bg-gradient-to-br from-primary via-indigo-600 to-blue-700 p-10 rounded-3xl shadow-2xl text-white text-center flex flex-col items-center hover:scale-105 transition duration-500">
